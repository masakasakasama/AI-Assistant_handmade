...
| Galaxy STT / Android TTS / 音声キャンセル | v0.4.0で縦切り実装。v0.4.2で言語別STT切替・診断表示を追加。v0.4.3でBackend URLを初期設定。v0.4.4で日英独の自動言語検出を既定化。v0.4.5で音声状態と同期するマスコット表示を追加。v0.4.6でLuna-first / Jev-firstの音声比較と初段判定比較を追加。実Galaxy評価中 |
